...
public class BooksForTotsGUI extends JFrame implements ActionListener {
	...
	public BooksForTotsGUI() {
		...
		prevbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(currentBookNum > 0) {
					...
					JOptionPane.showMessageDialog(mainPanel, "Reached the lowest number of books", "Error", JOptionPane.WARNING_MESSAGE);
				}
			}
		...
		nextbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(currentBookNum < b.getNumBooks() - 1) {
					...
					JOptionPane.showMessageDialog(mainPanel, "Reached the highest number of books", "Error", JOptionPane.WARNING_MESSAGE);
				}
			}
		...
		menuItem.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int n = JOptionPane.showConfirmDialog(mainPanel, "Are you sure you want to exit?", "Exit", JOptionPane.YES_NO_OPTION);
				if(n==0){
					System.exit(0);
				} else if(n==1) {
				}
		...
		constraints.gridy = 8;
		/**
		mainPanel.add(submitbtn, constraints);
		constraints.gridwidth = 20;
		constraints.gridx = 5;
		mainPanel.add(cancelbtn, constraints);
		**/
